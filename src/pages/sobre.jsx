       ...
       <Barra />   
        <main>  
         ...
         <section className="center-corpo">
          ...
          <p className="center-corpo-paragrafo">Hogwarts Legacy será lançado no dia  
          ...
          <p className="center-corpo-paragrafo">Hogwarts Legacy estará disponível para os consoles
           <strong> PlayStation®5, PlayStation®4, PlayStation®4 Pro, Xbox Series X|S, Xbox One, Nintendo Switch e PC.</strong> 
            
          </p>
          <p className="center-corpo-paragrafo">É possível vincular os dados da sua conta   
